...
function enterContents(){
    if(approveType1BothPAndL.checked){
        ...
        approveType1PetitionConditions.style.display = "none"
        approveType1PetitionKeyInputs.style.display = "none"
        approveType1LetterContent.style.display = "none";
        approveType1LetterKeyInputs.style.display = "none";
        approveType1LetterConditions.style.dispaly = "none";
    }
    if(approveType1Petition.checked){
        approveType1BothPAndLPContent.style.display = "none";
        approveType1BothPAndLKeyInputs.style.display = "none";
        approveType1BothPAndLPConditions.style.display = "none"
        approveType1BothPAndLLContent.style.display = "none";
        approveType1BothPAndLLConditions.style.display = "none";
        approveType1PetitionContent.style.display = "block";
        approveType1PetitionConditions.style.display = "block"
        approveType1PetitionKeyInputs.style.display = "block"
        approveType1LetterContent.style.display = "none";
        approveType1LetterKeyInputs.style.display = "none";
        approveType1LetterConditions.style.dispaly = "none";
    }
    if(approveType1Letter.checked){
        ...
        approveType1LetterKeyInputs.style.display = "block";
        approveType1LetterConditions.style.dispaly = "block";
    }
}
